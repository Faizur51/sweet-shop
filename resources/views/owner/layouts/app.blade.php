        ...
        <div class="rightside-header">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    ...
                    <div class="user-info">
                        <span class="user-name">gsss</span>
            ...
            <div class="header-section">
                ...
                <form method="POST" action="{{ route('owner.logout') }}">
                    @csrf
                    <a href="route('owner.logout')"  onclick="event.preventDefault(); this.closest('form').submit();"  data-toggle="tooltip" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
