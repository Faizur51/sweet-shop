...
<head>
    ...
    <!--load progress bar-->
    <script src="{{asset('assets/backend/user')}}/vendor/pace/pace.min.js"></script>
    <link href="{{asset('assets/backend/user')}}/vendor/pace/pace-theme-minimal.css" rel="stylesheet" />
    ...
    <!-- ========================================================= -->
    <!--Notification msj-->
    <link rel="stylesheet" href="{{asset('assets/backend/user')}}/vendor/toastr/toastr.min.css">
    <!--Magnific popup-->
    <link rel="stylesheet" href="{{asset('assets/backend/user')}}/vendor/magnific-popup/magnific-popup.css">
    <!--TEMPLATE css-->
    <!-- ========================================================= -->
...
<div class="wrap">
    ...
    <div class="page-header">
        ...
        <div class="leftside-header">
            <div class="logo">
                <a href="{{route('user.dashboard')}}" class="on-click">
                    <img alt="logo" src="{{asset('assets/backend/user')}}/images/header-logo.png" />
                </a>
            </div>
        ...
        <div class="rightside-header">
                        ...
                        <div class="drop-content">
                            <div class="widget-list list-left-element">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <div class="left-element"><img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_1.jpg" /></div>
                                            <div class="text">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="left-element"><img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_2.jpg" /></div>
                                            <div class="text">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="left-element"><img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_3.jpg" /></div>
                                            <div class="text">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="left-element"><img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_4.jpg" /></div>
                                            <div class="text">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="left-element"><img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_5.jpg" /></div>
                                            <div class="text">
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    <div class="user-photo">
                        <img alt="profile photo" src="{{asset('assets/backend/user')}}/images/avatar/avatar_user.jpg" />
                    </div>
                    <div class="user-info">
            ...
            <div class="header-section">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a href="route('logout')"  onclick="event.preventDefault(); this.closest('form').submit();"  data-toggle="tooltip" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            <!--HOME-->
                            <li class="{{request()->is('user/dashboard') ? 'active-item':''}}"><a href="{{route('user.dashboard')}}"><i class="fa fa-home" aria-hidden="true"></i><span>Dashboard</span></a></li>

                            <!--UI ELEMENTENTS-->
                            <li class="has-child-item close-item {{request()->is('user/product/*') ? 'open-item':''}}">
                                <a><i class="fa fa-cubes" aria-hidden="true"></i><span>Product</span></a>
                                <ul class="nav child-nav level-1">
                                    <li class="{{request()->is('user/product/create') ? 'active-item':''}}"><a href="{{route('user.product.create')}}">Add Product</a></li>
                                    <li class="{{request()->is('user/product/manage') ? 'active-item':''}}"><a href="{{route('user.product.manage')}}">Manage Product</a></li>
...
<!-- ========================================================= -->
<!--Notification msj-->
<script src="{{asset('assets/backend/user')}}/vendor/toastr/toastr.min.js"></script>
<!--morris chart-->
<script src="{{asset('assets/backend/user')}}/vendor/chart-js/chart.min.js"></script>
<!--Gallery with Magnific popup-->
<script src="{{asset('assets/backend/user')}}/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
<!--Examples-->
<script src="{{asset('assets/backend/user')}}/javascripts/examples/dashboard.js"></script>
</body>
